...
public class PTImageView extends AppCompatImageView {
    ...
    public PTImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PTImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initCustomAttrs(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.PTImageView);
