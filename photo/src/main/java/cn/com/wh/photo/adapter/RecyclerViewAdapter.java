...
import cn.com.wh.photo.adapter.listener.OnItemChildCheckedChangeListener;
import cn.com.wh.photo.adapter.listener.OnItemChildClickListener;
import cn.com.wh.photo.adapter.listener.OnItemChildLongClickListener;
import cn.com.wh.photo.adapter.listener.OnRVItemChildTouchListener;
...
public abstract class RecyclerViewAdapter<M> extends RecyclerView.Adapter<RecyclerViewHolder> {
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        RecyclerViewHolder viewHolder = new RecyclerViewHolder(this, mRecyclerView, LayoutInflater.from(mContext).inflate(viewType, parent, false), mOnRVItemClickListener, mOnRVItemLongClickListener);
