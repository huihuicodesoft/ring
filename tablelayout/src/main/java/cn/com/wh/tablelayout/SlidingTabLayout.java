...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTabPadding = ta.getDimension(R.styleable.SlidingTabLayout_tl_tab_padding, (mTabSpaceEqual || mTabWidth > 0 ? dp2px(0) : dp2px(20)) * 1);
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    public void setMsgMargin(int position, float leftPadding, float bottomPadding) {
        ...
        if (tipView != null) {
            ...
            if (mTabWidth >= 0) {
                lp.leftMargin = (int) (mTabWidth / 2 + textWidth / 2 + dp2px(leftPadding));
            } else {
                lp.leftMargin = (int) (mTabPadding + textWidth + dp2px(leftPadding));
            }
            if (mHeight > 0) {
                lp.topMargin = (int) (mHeight - textHeight) / 2 - dp2px(bottomPadding);
            } else {
                lp.topMargin = 0;
            }
