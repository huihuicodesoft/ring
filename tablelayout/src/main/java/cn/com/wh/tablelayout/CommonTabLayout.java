...
import cn.com.wh.tablelayout.utils.FragmentChangeManager;
import cn.com.wh.tablelayout.utils.UnreadMsgUtils;
import cn.com.wh.tablelayout.widget.MsgView;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener{
    ...
    public CommonTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mHeight = a.getDimensionPixelSize(0, 20);
        a.recycle();
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTabPadding = ta.getDimension(R.styleable.CommonTabLayout_tl_tab_padding, (mTabSpaceEqual || mTabWidth > 0 ? dp2px(0) : dp2px(10)) * 1f);

        ta.recycle();
    }

    public void setTabData(ArrayList<TabEntity> tabEntities) {
    ...
    /** 关联数据支持同时切换fragments */
    public void setTabData(ArrayList<TabEntity> tabEntities, FragmentActivity fa, int containerViewId, ArrayList<Fragment> fragments) {
    ...
    public void setMsgMargin(int position, float leftPadding, float bottomPadding) {
        ...
        if (tipView != null) {
            ...
            if (mIconGravity == Gravity.TOP || mIconGravity == Gravity.BOTTOM) {
                ...
                if (mHeight > 0){
                    lp.topMargin = (int) (mHeight - textHeight - iconH - margin) / 2 - dp2px(bottomPadding);
                } else {
                ...
                lp.leftMargin = dp2px(leftPadding);
                if (mHeight > 0){
                    lp.topMargin = (int) (mHeight - Math.max(textHeight, iconH)) / 2 - dp2px(bottomPadding);
                } else {
                    lp.topMargin = dp2px(bottomPadding);
                }
            }
