...
public class HelpFragment extends ButterKnifeFragment {
    ...
    private void initView() {
        ...
        mListSwipeRefreshLayout.getRecyclerView().setAdapter(mAdapter);
        ...
        mListSwipeRefreshLayout.getRecyclerView().addItemDecoration(lineItemDecoration);
